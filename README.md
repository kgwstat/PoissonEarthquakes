...
In the event of a large enough earthquake (≥7.7) this dynamic changes, as Omori's law will kick in and the probability of another earthquake of ≥6.5 before the end of the week decays geometrically instead of exponentially as implied by the Poisson model. In such an event, the Poisson model would overestimate the probability of no earthquakes of ≥6.5 and underestimate the probability of 1 or more earthquakes of ≥6.5.
